...
#ifdef _M_IX86	// INTEL
#ifdef DEBUG
	TCHAR	g_szEXEComponentCode[MAX_GUID+1]	= TEXT("{5CB2D5F5-19DD-11d1-9A9D-006097C4E489}");
	TCHAR	g_szDLLComponentCode[MAX_GUID+1]	= TEXT("{5CB2D5F4-19DD-11d1-9A9D-006097C4E489}");
#else		// SHIP
...
#else		// ALPHA
	TCHAR	g_szEXEComponentCode[MAX_GUID+1]	= TEXT("{5CB2D5F1-19DD-11d1-9A9D-006097C4E489}");
	TCHAR	g_szDLLComponentCode[MAX_GUID+1]	= TEXT("{5CB2D5F0-19DD-11d1-9A9D-006097C4E489}");
