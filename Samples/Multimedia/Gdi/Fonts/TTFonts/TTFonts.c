  ...
  switch (message) {
    ...
    *  in structures between different windows.)
    ...
    case WM_COMMAND: {
      ...
      switch (LOWORD(wParam)) {
         ...
         */
        case TBID_CREATE:
          SendMessage (hwndDlgLF, WMU_LFTODEMO, 0, (LONG_PTR) &lf);
          flyWinWin (hwndMain, hwndDlgLF, hwndDisplay, FWW_STEPS);
          SendMessage (hwndDisplay , WMU_NEWFONT, 0, (LONG_PTR) &lf);
        break;
        ...
        case TBID_GETTM:
          ...
          SendMessage (hwndDisplay , WMU_DEMOTOTM, 0, (LONG_PTR) &tm);
          flyWinWin (hwndMain, hwndDisplay, hwndDlgTM, FWW_STEPS);
          SendMessage (hwndDlgTM, WMU_DEMOTOTM, 0, (LONG_PTR) &tm);
        ...
        *  it back in the dialog.  Force a createfont message.
        ...
        case IDM_HELP:
          WinHelp( hwnd, szHelpPathName, HELP_INDEX, (DWORD_PTR) NULL );
        break;
    ...
    *  created and then call postquitmessage.
    ...
    case WM_DESTROY:
      ...
      WinHelp( hwnd, szHelpPathName, (UINT) HELP_QUIT, (DWORD_PTR) NULL );
      PostQuitMessage(0);
    break;
