...
public:
  ...
  CDADrag::CDADrag(IDAGeometryPtr im, IDAPoint3Ptr pt, IDAStaticsPtr e);
  ...
  IDAGeometryPtr getGeometryPtr()  { 
	...
	STDMETHOD(initNotify)(IDAGeometryPtr geo, CDARelease *releaseHdlr, IDAPoint3Ptr pt, IDAStaticsPtr e);
  STDMETHOD(Cleanup)();
