    ...
    )
{
	...
	// Get the LSTSlot address or the Data offset
	if ( fDataLocation )
		return (ROWBUFF *) (m_rgbRowData + m_cbTotalRowSize*iRow);
	else
		return (ROWBUFF *) (m_rgbRowData + m_cbRowSize + (m_cbTotalRowSize*(iRow-1)));
}
