...
INT_PTR APIENTRY DoDialog(LPTSTR lpTemplateName, DLGPROC lpDlgProc, LPARAM param, BOOL fRememberFocus);
LRESULT  APIENTRY MainWndProc(HWND, UINT, WPARAM, LPARAM);
BOOL  APIENTRY About(HWND, UINT, WPARAM, LPARAM);
BOOL  APIENTRY RenderDelayDlgProc(HWND, UINT, WPARAM, LPARAM);
BOOL  APIENTRY SetTopicDlgProc(HWND, UINT, WPARAM, LPARAM);
BOOL  APIENTRY SetServerDlgProc(HWND, UINT, WPARAM, LPARAM);
...
HDDEDATA CALLBACK DdeCallback(UINT wType, UINT wFmt, HCONV hConv, HSZ hszTopic,
        HSZ hszItem, HDDEDATA hData, ULONG_PTR lData1, ULONG_PTR lData2);
