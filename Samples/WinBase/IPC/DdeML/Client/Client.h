...
typedef struct {    // used to passinfo to/from TransactionDlgProc and
    DWORD_PTR ret;  // TextEntryDlgProc.
    DWORD Result;
    DWORD ulTimeout;
    DWORD wType;
    HCONV hConv;
...
LRESULT APIENTRY MDIChildWndProc(HWND, UINT, WPARAM, LPARAM);
...
LRESULT APIENTRY DoDialog(LPTSTR lpTemplateName, DLGPROC lpDlgProc, LPARAM param,
        BOOL fRememberFocus);
