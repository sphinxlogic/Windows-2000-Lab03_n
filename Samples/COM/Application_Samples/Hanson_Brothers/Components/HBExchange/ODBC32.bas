...
Declare Function SQLEndTran Lib "odbc32.dll" (ByVal HandleType%, ByVal Handle&, ByVal CompletionType%) As Integer
...
Declare Function SQLSetConnectAttr Lib "odbc32.dll" (ByVal hdbc&, ByVal Attrib%, ByVal ValuePtr&, ByVal StringLength%) As Integer
Declare Function SQLSetStmtAttr Lib "odbc32.dll" (ByVal hstmt&, ByVal Attrib%, ByVal ValuePtr&, ByVal StringLength%) As Integer
...
Global Const SQL_ATTR_AUTOCOMMIT As Long = SQL_AUTOCOMMIT

'  Handle type identifiers (ODBC 3.0)
Global Const SQL_HANDLE_ENV As Long = 1
Global Const SQL_HANDLE_DBC As Long = 2
Global Const SQL_HANDLE_STMT As Long = 3
Global Const SQL_HANDLE_DESC As Long = 4

'  Statement attributes for ODBC 3.0
Global Const SQL_ATTR_ASYNC_ENABLE As Long = 4
Global Const SQL_ATTR_CONCURRENCY  As Long = SQL_CONCURRENCY
Global Const SQL_ATTR_CURSOR_TYPE As Long = SQL_CURSOR_TYPE
Global Const SQL_ATTR_ENABLE_AUTO_IPD  As Long = 15
Global Const SQL_ATTR_FETCH_BOOKMARK_PTR As Long = 16
Global Const SQL_ATTR_KEYSET_SIZE As Long = SQL_KEYSET_SIZE
Global Const SQL_ATTR_MAX_LENGTH As Long = SQL_MAX_LENGTH
Global Const SQL_ATTR_MAX_ROWS As Long = SQL_MAX_ROWS
Global Const SQL_ATTR_NOSCAN As Long = SQL_NOSCAN
Global Const SQL_ATTR_PARAM_BIND_OFFSET_PTR As Long = 17
Global Const SQL_ATTR_PARAM_BIND_TYPE As Long = 18
Global Const SQL_ATTR_PARAM_OPERATION_PTR As Long = 19
Global Const SQL_ATTR_PARAM_STATUS_PTR As Long = 20
Global Const SQL_ATTR_PARAMS_PROCESSED_PTR As Long = 21
Global Const SQL_ATTR_PARAMSET_SIZE As Long = 22
Global Const SQL_ATTR_QUERY_TIMEOUT As Long = SQL_QUERY_TIMEOUT
Global Const SQL_ATTR_RETRIEVE_DATA As Long = SQL_RETRIEVE_DATA
Global Const SQL_ATTR_ROW_BIND_OFFSET_PTR As Long = 23
Global Const SQL_ATTR_ROW_BIND_TYPE As Long = SQL_BIND_TYPE
Global Const SQL_ATTR_ROW_NUMBER As Long = SQL_ROW_NUMBER      ' GetStmtAttr
Global Const SQL_ATTR_ROW_OPERATION_PTR As Long = 24
Global Const SQL_ATTR_ROW_STATUS_PTR As Long = 25
Global Const SQL_ATTR_ROWS_FETCHED_PTR As Long = 26
Global Const SQL_ATTR_ROW_ARRAY_SIZE As Long = 27
Global Const SQL_ATTR_SIMULATE_CURSOR As Long = SQL_SIMULATE_CURSOR
Global Const SQL_ATTR_USE_BOOKMARKS As Long = SQL_USE_BOOKMARKS

' return values (ODBC 3.0)
Global Const SQL_NO_DATA As Long = 100
