...
class Pz15ControlPanel extends UIPanel implements Pz15Consts, Pz15Callbacks, Runnable
{
	...
	private boolean			solversuspended = false;
	...
	public void displayOptionsDialog()
	{
		...
		PropsThread propsthr = new PropsThread(props, this);
		propsthr.start();
	}

	public void doOptionsFinished()
	{
		info.marquee.is_on = true;
...
class PropsThread extends Thread
{
	private Pz15Options props;
	private Pz15ControlPanel pzctrl;

	public PropsThread(Pz15Options pzopts, Pz15ControlPanel ctrl)
	{
		props = pzopts;
		pzctrl = ctrl;
	}
	...
	public void run()
	{
		pzctrl.appmodal = true;
		props.display();
		pzctrl.doOptionsFinished();
		pzctrl.appmodal = false;
	}
}
