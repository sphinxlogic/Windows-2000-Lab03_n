...
int initDlg(HWND hwndMain)
{
  ...
  SetClassLongPtr (hwndDlgLF, GCLP_HICON, (LONG_PTR)LoadIcon(hInst, TEXT("ttfontsIcon")));
    ...
    case WMU_GETFONTDATA: {
        ...
        if (dwNBytes == -1) {
          ...
          for (i = 0; i< nStrings; i++) {
            ...
            SendDlgItemMessage (hwnd, DID_LISTBOX, LB_ADDSTRING, 0, (LONG_PTR) buffer);
          }
        }
...
#define LBPUT SendDlgItemMessage (hwnd, DID_LISTBOX, LB_ADDSTRING, 0, (LONG_PTR) buffer);
