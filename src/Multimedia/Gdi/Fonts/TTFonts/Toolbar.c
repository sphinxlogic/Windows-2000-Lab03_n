  ...
  switch (message) {
    ...
    *  distinguished.
    ...
    case WM_CREATE: {
      ...
      SetWindowLongPtr (hwndButton, GWLP_ID, TBID_ENUM);
      ...
      hwndButton = CreateWindow(
        ...
        hwnd, NULL, hInst, NULL);
      SetWindowLongPtr (hwndButton, GWLP_ID, TBID_CREATE);
      ...
      hwndButton = CreateWindow(
        ...
        hwnd, NULL, hInst, NULL);
      SetWindowLongPtr (hwndButton, GWLP_ID, TBID_GETTM);
      ...
      hwndButton = CreateWindow(
        ...
        hwnd, NULL, hInst, NULL);
      SetWindowLongPtr (hwndButton, GWLP_ID, TBID_GETFONTDATA);
      ...
      hwndEnumPrinter = CreateWindow(
        ...
        hwnd, NULL, hInst, NULL);
      SetWindowLongPtr (hwndEnumPrinter, GWLP_ID, TBID_PRINT);
