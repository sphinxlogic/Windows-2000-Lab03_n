...
/* 14*/ {DBPROP_SESS_AUTOCOMMITISOLEVELS,	DBPROPFLAGS_SESSION | DBPROPFLAGS_READ,						VT_I4,	 FALSE,		0,							NULL,			L"Autocommit Isolation Levels"},
/* 15*/ {DBPROP_ACTIVESESSIONS,				DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_I4,	 FALSE,		1,							NULL,			L"Active Sessions"},
/* 16*/ {DBPROP_PERSISTENTIDTYPE,			DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_I4,	 FALSE,		DBPROPVAL_PT_GUID_PROPID,	NULL,			L"Persistent ID Type"},
/* 17*/ {DBPROP_PROVIDERFILENAME,			DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_BSTR, FALSE,		0,							L"SAMPPROV.DLL",L"Provider Name"},
/* 18*/ {DBPROP_PROVIDERFRIENDLYNAME,		DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_BSTR, FALSE,		0,							L"Microsoft OLE DB Sample Provider",	L"Provider Friendly Name"},
/* 19*/ {DBPROP_PROVIDEROLEDBVER,			DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_BSTR, FALSE,		0,							L"02.00",		L"OLE DB Version"},
/* 20*/ {DBPROP_PROVIDERVER,				DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_BSTR, FALSE,		0,							_TEXT(VER_PRODUCTVERSION_STR),			L"Provider Version"},
/* 21*/ {DBPROP_ROWSETCONVERSIONSONCOMMAND, DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_BOOL, TRUE,		0,							NULL,			L"Rowset Conversions on Command"},
/* 22*/ {DBPROP_OLEOBJECTS,					DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ,				VT_I4,   FALSE,		DBPROPVAL_OO_DIRECTBIND|DBPROPVAL_OO_ROWOBJECT|DBPROPVAL_OO_SINGLETON,	NULL, L"OLE Object Support"},
/* 23*/ {DBPROP_INIT_DATASOURCE,			DBPROPFLAGS_DBINIT | DBPROPFLAGS_READ | DBPROPFLAGS_WRITE,	VT_BSTR, FALSE,		0,							L"",			L"Data Source"},
/* 24*/ {DBPROP_INIT_HWND,					DBPROPFLAGS_DBINIT | DBPROPFLAGS_READ | DBPROPFLAGS_WRITE,	VT_I4,	 FALSE,		0,							NULL,			L"Window Handle"},
/* 25*/ {DBPROP_INIT_PROMPT,				DBPROPFLAGS_DBINIT | DBPROPFLAGS_READ | DBPROPFLAGS_WRITE,	VT_I2,   FALSE,		4,							NULL,			L"Prompt"}
    };
