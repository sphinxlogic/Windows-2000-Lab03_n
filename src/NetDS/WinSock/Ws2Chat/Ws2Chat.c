...
--*/
{
    ...
    case WM_CREATE:
        ...
        OldEditWndProc = (FARPROC) SetWindowLongPtr(ConnData->SendWindow,
                                                GWLP_WNDPROC,
                                                (DWORD_PTR)SendEditSubClass);
        SetWindowLongPtr(ConnData->RecvWindow,
                      GWLP_WNDPROC,
                      (DWORD_PTR)RecvEditSubClass);
        ...
        SetWindowLongPtr(WindowHandle, GWL_CONNINFO, (DWORD_PTR)ConnData);
...
--*/
{
    ...
    INT_PTR NumChars;              // how many characters we put in Buffer
...

{
    ...
    LRESULT      ReturnValue = TRUE; // holds the return value
...
--*/
{
    ...
    INT_PTR  CharIndex1;
    INT_PTR  CharIndex2;
    INT_PTR  LineIndex;   // index variables
