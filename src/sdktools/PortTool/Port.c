...
****************************************************************************/
unsigned char * __cdecl My_mbschr(
...
****************************************************************************/
unsigned char * __cdecl My_mbstok(
...
/****************************************************************************
    My_mbsncpy:
****************************************************************************/
unsigned char * __cdecl My_mbsncpy(
        ...
        )
{
    ...
    if ((int)(hFile = (HANDLE)OpenFile (szIniFilePath, &of, OF_READ)) == HFILE_ERROR)
        return FALSE;
    else
        {
    ...
    char    *lpszFile)
{
    ...
    char    *lpPath;
        ...
        while ( *lpPath )
        {
           if ( *lpPath == '\\' || *lpPath == ':' )
           {
                  if (HFILE_ERROR != OpenFile (lpszFileName, &of, OF_EXIST))
                  {
    ...
    *lpPath = 0;
    ...
    /* test for existance */
    if (HFILE_ERROR == OpenFile (lpszPath, &of, OF_EXIST))
        {
