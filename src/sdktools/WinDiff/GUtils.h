...
unsigned char * __cdecl My_mbschr(unsigned char *, unsigned short);
...
unsigned char * __cdecl My_mbsrchr(unsigned char *, unsigned short);
int __cdecl My_mbsncmp(const unsigned char *, const unsigned char *, size_t);
