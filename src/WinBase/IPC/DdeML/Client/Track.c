...
VOID VertUpdate(HDC hdc, INT xOld, INT xNew, INT y1Old, INT y1New, INT y2Old,
        INT y2New);
LRESULT  APIENTRY TrackingWndProc(HWND hwnd, DWORD msg, WPARAM wParam, LPARAM lParam);
...
LPRECT prcResult)   // result rect in bounding window coords.
{
    ...
    lpOrgWndProc = (FARPROC)GetWindowLongPtr(hwnd, GWLP_WNDPROC);
    lpTrackWndProc = MakeProcInstance((FARPROC)TrackingWndProc, hInst);
    SetWindowLongPtr(hwnd, GWLP_WNDPROC, (DWORD_PTR)lpTrackWndProc);
    ...
    SetWindowLongPtr(hwnd, GWLP_WNDPROC, (DWORD_PTR)lpOrgWndProc);
 ...
 *                                                                          *
 ****************************************************************************/
LRESULT  APIENTRY TrackingWndProc(
HWND hwnd,
DWORD msg,
WPARAM wParam,
LPARAM lParam)
