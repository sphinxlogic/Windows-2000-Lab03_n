...
public class COMAdminCatalog implements IUnknown,com.ms.com.NoAutoScripting,comadmin.ICOMAdminCatalog
{
  ...
  /** @com.method(vtoffset=6, dispid=3, type=PROPGET, name="MajorVersion", name2="getMajorVersion", addFlagsVtable=4)
      @com.parameters([type=I4] return) */
  public native int getMajorVersion();

  /** @com.method(vtoffset=7, dispid=4, type=PROPGET, name="MinorVersion", name2="getMinorVersion", addFlagsVtable=4)
      @com.parameters([type=I4] return) */
  ...
  /** @com.method(vtoffset=17, dispid=14, type=METHOD, name="StopIMDB", addFlagsVtable=4)
      @com.parameters() */
  public native void StopIMDB();

  /** @com.method(vtoffset=18, dispid=15, type=METHOD, name="StartIMDB", addFlagsVtable=4)
      @com.parameters() */
  public native void StartIMDB();
